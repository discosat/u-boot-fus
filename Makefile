...
ALL += $(obj)u-boot.srec $(obj)u-boot.bin $(obj)System.map $(U_BOOT_NAND) $(U_BOOT_ONENAND) $(obj)uboot.nb0 $(obj)u-boot.dis
...
picomod6_config	:	unconfig
	echo "RAM_TEXT = 0x57f00000" >> $(obj)board/F+S/picomod6/config.tmp
	$(MKCONFIG) $(@:_config=) arm arm1176 picomod6 F+S s3c64xx

picocom3_config	:	unconfig
	echo "RAM_TEXT = 0x53f00000" >> $(obj)board/F+S/picocom3/config.tmp
	$(MKCONFIG) $(@:_config=) arm arm1176 picocom3 F+S s3c64xx
...
clobber:	clean
	...
	@rm -f $(obj)tools/{env/crc32.c,inca-swap-bytes,addfsheader}

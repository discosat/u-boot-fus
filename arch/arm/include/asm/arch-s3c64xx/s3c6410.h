...
/* PLL settings for APLL and MPLL; in SYNC MODE, both APLL and MPLL use MDIV;
   in ASYNC MODE, MPLL uses MDIV and APLL uses AMDIV; given numbers are in MHz
   if FIN=12MHz  */

...
#ifndef _S3C_REGS_LCD_H_
#define _S3C_REGS_LCD_H_
...
#define S3C_LCDREG(x)		((x) + S3C_PA_LCD)
...
#elif defined(CONFIG_S3C6400) || defined(CONFIG_S3C6410) || defined(CONFIG_S5P6440) || defined(CONFIG_S5PC100) || defined(CONFIG_S5PC110)

 ...
 *
 *
 * RAM layout of PicoCOM3 (RAM starts at 0x50000000) (64MB)
 * ---------------------------------------------------------
 ...
 *
 * NAND flash layout of PicoCOM3 (1GB) (Block size 128KB)
 * --------------------------------------------------------
...
#define CONFIG_PICOCOM3		1	  /* F&S PicoCOM3 Board */

/* Architecture magic and machine type */
#define MACH_TYPE		0xc4a	  /* PicoCOM3/Linux */
 ...
 * Serial console (UART)
 ************************************************************************/
#define CONFIG_SERIAL2          1	  /* SERIAL 2 (UART1) on PicoCOM3 */
...
#ifndef CONFIG_PICOCOM3 /* Already done in NBoot */
/************************************************************************
 * CPU (PLL) timings
 ************************************************************************/
...
#define MTDIDS_DEFAULT		"nand0=pc3nand0"
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"autoload=PicoCOM3/autoload.scr\0" \
	"autommc=1\0" \
	"autousb=3\0" \
	"autoaddr=50000000\0"
